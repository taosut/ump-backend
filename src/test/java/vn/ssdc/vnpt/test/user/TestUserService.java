package vn.ssdc.vnpt.test.user;
...
public class TestUserService {
    ...
    public void getPage() {
        ...
        NotificationSettingService noti = new NotificationSettingService(repositoryFactory);
        userService.notificationSettingService = noti;
    ...
    public void sendForgotPasswordEmail() {
        ...
        Assert.assertNotNull(userResult.forgotPwdTokenRequested);
    ...
    public void beforeCreate() {
        ...
        role001.operationIds.add("WEBAPP:DATAMODEL:DELETE");
