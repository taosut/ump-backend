 ...
 */
public class MonitoringQuartzJob implements Job {
        ...
        try {
            if(jobExecutionContext.getPreviousFireTime() != null) {
                ...
                if(jobExecutionContext.getPreviousFireTime() != null) {
                    ...
                    logger.info("#MONITORING_QUARTZ: " + fromDateTime + " - " + endDateTime);
                    alarmService.monitoringCWMPLog(fromDateTime, endDateTime);
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
